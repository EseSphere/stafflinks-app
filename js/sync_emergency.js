    ...
    async function runSync() {
        try {
            ...
            if (!db.objectStoreNames.contains('tbl_future_planning')) {
                console.warn(`Object store 'tbl_future_planning' not found. Sync aborted.`);
                return;
            }
            ...
            const response = await fetch(`sync_emergency.php?company_id=${companyId}`);
            ...
            const tableName = 'tbl_future_planning';
