(function() {
    ...
    async function runSync() {
        try {
            ...
            if (!db.objectStoreNames.contains('tbl_client_medical')) {
                console.warn(`Object store 'tbl_client_medical' not found. Sync aborted.`);
                return;
            }
            ...
            const response = await fetch(`sync_health.php?company_id=${companyId}`);
            ...
            const tableName = 'tbl_client_medical';
